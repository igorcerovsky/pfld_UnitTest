...
namespace UnitTest_pfd
{
	...
	public:
		...
		TEST_METHOD(Test_Body_T)
		{
			using flt = float;
			using facet = pfld::Facet < float >;
			...
			const point result(5.1341030021201644e-009f, 5.1341030021201644e-009f, 1.2401175118216113e-008f);
			const flt eps{ 1.0e-12f };
